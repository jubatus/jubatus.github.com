...
If you are building Jubatus on platform that does not provide ``python`` command (like Ubuntu 16.04 and 18.04), run ``sudo apt-get install python2.7`` to install ``python``, or try running ``waf`` via ``python3`` (e.g., ``python3 ./waf configure``).
