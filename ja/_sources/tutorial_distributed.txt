...
1. ZooKeeperのインストール
 ...
 ::
  ...
  $ sudo wget http://ftp.meisei-u.ac.jp/mirror/apache/dist/zookeeper/stable/zookeeper-3.4.6.tar.gz
...
2. ZooKeeperの設定ファイル（zoo.cfg）の作成
 ...
 zookeeper-3.4.6/conf 配下にサンプルの設定ファイルがありますので、そちらをコピーして作成してください。
